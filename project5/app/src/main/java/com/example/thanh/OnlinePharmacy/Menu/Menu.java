...
import com.example.thanh.OnlinePharmacy.Pay.fragment.PayCard;
import com.example.thanh.OnlinePharmacy.Prescription.Select_method_send_prescription;
import com.example.thanh.OnlinePharmacy.Prescription.fragments.receiverPrescriptionConfirm;
import com.example.thanh.OnlinePharmacy.Prescription.fragments.receiverPresciption;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        androidGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (i == 1) {
                    Intent passIntentPayCard = new Intent(Menu.this, PayCard.class);
