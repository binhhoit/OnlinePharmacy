...
import com.example.thanh.OnlinePharmacy.Prescription.fragments.QRcodePrescription;
import com.example.thanh.OnlinePharmacy.Prescription.fragments.takePhotoSentPrescription;
import com.example.thanh.OnlinePharmacy.Prescription.fragments.sendPresciption;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_photo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent TakePhoto = new Intent(Select_method_send_prescription.this, takePhotoSentPrescription.class);
        ...
        btn_QR.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent QRcode = new Intent(Select_method_send_prescription.this, QRcodePrescription.class);
